...
import examples.gadgets.rsa.RSATextbook_Gadget;


// a demo for RSA Encryption PKCS #1, V1.5
public class RSATextbookCircuitGenerator extends CircuitGenerator {
	...
	private RSATextbook_Gadget rsaTextbook_Gadget;

	public RSATextbookCircuitGenerator(String circuitName, int rsaKeyLength,
			int plainTextLength) {
		super(circuitName);
	...
	protected void buildCircuit() {
		...
		rsaTextbook_Gadget = new RSATextbook_Gadget(rsaModulus, inputMessage, rsaKeyLength);
		...
		Wire[] cipherTextInBytes = rsaTextbook_Gadget.getOutputWires(); // in bytes
...
//			System.out.println("ciphertext : " + new String(cipherText));
	...
	public static void main(String[] args) throws Exception {
		int keyLength = 2048;
		int msgLength = 3;
		RSATextbookCircuitGenerator generator = new RSATextbookCircuitGenerator(
